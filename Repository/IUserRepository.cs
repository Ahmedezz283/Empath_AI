...
namespace Empath_AI.Repository
{
    public interface IUserRepository
    {
        ...
        Task<(bool Success, string Message, string? ImageUrl)> AddUserProfile(int userId, UserProfilePictureDTO model);
        ...
        Task<(bool Success, string Message, int? id)> VerifyOtpAsync(string email, string otp);
    }
}
